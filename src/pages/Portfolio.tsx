          ...
          <div className="row portfolio-container">
            <div className="col-lg-4 col-md-6 portfolio-item filter-shop-floor wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/sho-floor.png"
                    className="img-fluid"
                    alt=""
                  />
                  <a
                    href="/img/portfolio/sho-floor.png"
            ...
            >
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src=".\assets\img\portfolio\vmc.jpg"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/vmc.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            >
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-1.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-1.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-2.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-2.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-3.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-3.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-4.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-4.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-5.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-5.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-6.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-6.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-7.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-7.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-8.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-8.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-9.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-9.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-10.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-10.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-products wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/product-11.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/product-11.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-equipments wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/Tech-supp-1.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/Tech-supp-1.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-equipments wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/Tech-supp-2.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/Tech-supp-2.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-equipments wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/Tech-supp-3.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/Tech-supp-3.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-equipments wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/Tech-supp-4.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/Tech-supp-4.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-equipments wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/Tech-supp-5.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/Tech-supp-5.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item filter-equipments wow fadeInUp">
              <div className="portfolio-wrap">
                <figure>
                  <img
                    src="/img/portfolio/Tech-supp-6.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Link
                    to="/img/portfolio/Tech-supp-6.png"
                    className="link-preview portfolio-lightbox"
                    data-gallery="portfolioGallery"
                    title="Preview"
                  >
